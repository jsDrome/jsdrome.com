  ...
  render() {
    ...
    return <div>
      <div className={classes.people}>
        ...
        <Typography variant="body1" className={classes.text}>Contributors</Typography>
        <div className={classes.contributors}>
        ...
        <Typography variant="body1" className={classes.text}>Outside contributors</Typography>
        <div className={classes.contributors}>
